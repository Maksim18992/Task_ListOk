...
## Тест-кейс №1 - Проверка корректности показателей процента, при выборе произвольного периода первого дня месяца
...
## Тест-кейс №2 - Проверка корректности показателей процента, при выборе произвольного периода 31 августа
